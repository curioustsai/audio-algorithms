...
set(UBNT_FW_CACHE /home/harold/linaro/aarch64/gcc-linaro-7.4.1-2019.02-x86_64_aarch64-linux-gnu/)

#where the C and C++ compilers are located
set(
    CMAKE_C_COMPILER
    ${UBNT_FW_CACHE}/bin/aarch64-linux-gnu-gcc
)
set(
    CMAKE_CXX_COMPILER
    ${UBNT_FW_CACHE}/bin/aarch64-linux-gnu-g++
)

#where is the sysroot
set(
    CMAKE_FIND_ROOT_PATH
    /home/harold/.ubnt/cache/gen4l/barebones/staging_dir/target-aarch64-openwrt-linux-gnu
)

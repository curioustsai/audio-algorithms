...
void sf_simplecomp(sf_compressor_state_st *state, int rate, float pregain, float postgain, float threshold,
...
void sf_compressor_process(sf_compressor_state_st *state, int size, float *input,
	float *output){

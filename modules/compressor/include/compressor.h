...
void sf_simplecomp(
    ...
    float threshold_agg, // dB, level where aggressive compression kicks in [-100 to 0]
    float ratio_agg, // unitless, amount to inversely scale the output when applying aggressive comp [1 to 20]
    float threshold_expander, // dB, level where expander kicks in [-100 to 0]
    float ratio_expander, // unitless, amount to inversely scale the output when applying expander [1 to 20]
